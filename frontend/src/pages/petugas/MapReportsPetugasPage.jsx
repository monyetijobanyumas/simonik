// ============================================================
// SIMONIK - Map Reports Petugas Page
// File: src/pages/petugas/MapReportsPetugasPage.jsx
// Deskripsi: Peta laporan scope petugas — legend clickable
// ============================================================
...
export default function MapReportsPetugasPage() {
    ...
    <div style={styles.container}>
      <div style={styles.header}>
        <div>
          ...
          <h1 style={styles.title}>Peta Laporan Scope Anda</h1>
          <p style={styles.subtitle}>
            {reports.length} laporan di scope Anda
          </p>
        </div>
      ...
      {reports.length === 0 ? (
        <div style={styles.emptyBox}>
          ...
          <p style={styles.emptyText}>
            Belum ada laporan di scope Anda yang bisa ditampilkan.
          </p>
        </div>
      ) : (
        <>
