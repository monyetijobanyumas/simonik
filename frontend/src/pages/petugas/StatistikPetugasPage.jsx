// ============================================================
// SIMONIK - Statistik Page (Petugas)
// File: src/pages/petugas/StatistikPetugasPage.jsx
// Deskripsi: Dashboard statistik laporan scope petugas
// ============================================================
...
export default function StatistikPetugasPage() {
    ...
    <div style={styles.container}>
      <div style={styles.header}>
        <div>
          ...
          <h1 style={styles.title}>Statistik Laporan Scope Anda</h1>
          <p style={styles.subtitle}>
            Ringkasan data laporan di scope Anda
          </p>
        </div>
        <button
      ...
      {reports.length === 0 ? (
        <div style={styles.emptyBox}>
          ...
          <p style={styles.emptyText}>
            Belum ada laporan di scope Anda untuk ditampilkan statistiknya.
          </p>
        </div>
      ) : (
        <>
          <div style={styles.summaryGrid}>
            ...
            {Object.entries(STATUS_INFO).map(([key, info]) => (
              <div key={key} style={styles.summaryCard}>
                <div style={{ ...styles.summaryLabel, color: info.color }}>
                  {info.label}
                </div>
                <div style={{ ...styles.summaryValue, color: info.color }}>
                  {statusCounts[key]}
                </div>
              </div>
            ))}
